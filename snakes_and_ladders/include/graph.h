 ...
 * @param graph_array Pointer to an array of node pointers. An array of pointers to all nodes is saved into this parameter. Used primarily for freeing memory via cleanup_graph().  
 * 
